                ...
                <div class="col-md-6 col-lg-6 col-xl-7 d-none d-md-flex bg-primary-transparent">
                    <div class="row wd-100p mx-auto text-center">
                        <div class="col-md-12 col-lg-12 col-xl-12 my-auto mx-auto wd-100p">
                            <img src="backend/assets/img/media/login.png"
                                ...
                                <div class="col-md-10 col-lg-10 col-xl-9 mx-auto">
                                    <div class="card-sigin">
                                        <div class="mb-5 d-flex"> <a href="index.html"><img
                                                    src="backend/assets/img/brand/favicon.png" class="sign-favicon ht-40"
                                                    alt="logo"></a>
                                        ...
                                        <div class="card-sigin">
                                            <div class="main-signup-header">
                                                ...
                                                ?> </h5>
                                                <form action="./user/signin-save.php" method="POST">
                                                    ...
                                                    </div><button type="submit" name="login" class="btn btn-main-primary btn-block">Sign
                                                        In</button>
                                                ...
                                                <div class="main-signin-footer mt-5">
                                                    ...
                                                    <p>Don't have an account? <a href="signup.php">Create an
                                                            Account</a></p>
                                                </div>
                                            </div>
                                        </div>
