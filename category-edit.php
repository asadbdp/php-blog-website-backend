                        ...
                        <div class="col-md-10 col-lg-10 col-xl-9 mx-auto">
                            <div class="card-sigin">
                                <div class="main-signup-header bg-white p-5 rounded">
                                    ...
                                    <form action="./blog/category-update.php" method="POST">
                                    <input class="form-control" name="id" value="<?php echo $row['id'];?>" type="hidden">
                                        ...
                                        <div class="form-group">
                                            <label for="cat_name">Category Name</label> <input class="form-control"
                                                name="cat_name" value="<?php echo $row['cat_name'];?>" id="cat_name" placeholder="Enter your Category name"
                                                type="text">
                                        </div>
                                        <div class="form-group">
                                            <label for="cat_short_des">Category Description</label> <input
                                                class="form-control" id="cat_short_des" value="<?php echo $row['cat_short_des'];?>" name="cat_short_des"
